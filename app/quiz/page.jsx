        ...
        >
            ...
            <div className="md:w-[50%] flex flex-col gap-5">
                <h1 className="text-2xl font-semibold">
                    Royal Ambassadors - Extraordinary and Plenipotentiary Quiz
                </h1>
                <p className="text-sm leading-6 text-gray-300">
                    Take this quiz to find out how much you know about the Royal
                    Ambassadors of Nigeria its leaders and Current affairs of
                    the nation.
                </p>
                <Link
